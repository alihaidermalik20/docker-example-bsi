  ...
  describe(`${solution.name}: returns the bonus amount`, () => {
    describe('gives correct bonus to all the doctors', () => {
      describe('gives correct bonus to doctors with less than 10 years of experience', () => {
        for (let i = 0; i < 10; i++) {
          it('return 200 * 1.5 = 300 for less than 10y exp', () => {
            expect(solution({ profession: 'doctor', experience: i }, 200)).toBe(300);
          });
          it('return 400 * 1.5 = 600 for less than 10y exp', () => {
            expect(solution({ profession: 'doctor', experience: i }, 400)).toBe(600);
          });
          it('return 600 * 1.5 = 900 for less than 10y exp', () => {
            expect(solution({ profession: 'doctor', experience: i }, 600)).toBe(900);
          });
        }
      });
      describe('gives correct bonus to doctors 10 to 19 years of exp', () => {
        for (let i = 10; i < 20; i++) {
          it('200 * 2 = 400', () => {
            expect(solution({ profession: 'doctor', experience: i}, 200)).toBe(400);
          });
          it('400 * 2 = 800', () => {
            expect(solution({ profession: 'doctor', experience: i}, 400)).toBe(800);
          });
          it('600 * 2 = ERROR', () => {
      ...
      describe('gives correct bonus to doctors with 20 and more years of experience upto 55y of exp', () => {
        for (let i = 20; i <= 55; i++) {
          it('200 * 3 = 600', () => {
            expect(solution({ profession: 'doctor', experience: i}, 200)).toBe(600);
          });
          it('400 * 3 = ERROR', () => {
